 ...
 * @author mansh
 */
public class AddTG extends javax.swing.JDialog {
    private ToolBarAndTableTacGia tblTG;
    public AddTG(java.awt.Frame parent, boolean modal, ToolBarAndTableTacGia tblTG) {
        super(parent, modal);
        initComponents();
        this.tblTG = tblTG;
    }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (errors == null || errors.isEmpty()) {
            ...
            if (result > 0) {
                JOptionPane.showMessageDialog(this, "Thêm TG thành công!", "Thành công!", JOptionPane.INFORMATION_MESSAGE);
                tblTG.refreshDataListTG();
                tblTG.loadDataTG(tblTG.getListTG());
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Thêm TG thất bại, lỗi hệ thống!", "Thất bại", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, errors, "Thêm TG thất bại", JOptionPane.INFORMATION_MESSAGE);
        }

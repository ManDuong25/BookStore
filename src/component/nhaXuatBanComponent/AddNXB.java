 ...
 * @author mansh
 */
public class AddNXB extends javax.swing.JDialog {
    private ToolBarAndTableNhaXuatBan tblNXB;
    public AddNXB(java.awt.Frame parent, boolean modal, ToolBarAndTableNhaXuatBan tblNXB) {
        super(parent, modal);
        initComponents();
        this.tblNXB = tblNXB;
    }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (errors == null || errors.isEmpty()) {
            ...
            if (result > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Thêm NXB thất bại, lỗi hệ thống!", "Thất bại", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, errors, "Thêm NXB thất bại", JOptionPane.INFORMATION_MESSAGE);
        }

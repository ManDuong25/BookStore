 ...
 * @author mansh
 */
public class AddNCC extends javax.swing.JDialog {
    private ToolBarAndTableNCC tblNCC;
    public AddNCC(java.awt.Frame parent, boolean modal, ToolBarAndTableNCC tblNCC) {
        super(parent, modal);
        initComponents();
        this.tblNCC = tblNCC;
    }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (errors == null || errors.isEmpty()) {
            ...
            if (result > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Thêm NCC thất bại, lỗi hệ thống!", "Thất bại", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, errors, "Thêm NCC thất bại", JOptionPane.INFORMATION_MESSAGE);
        }

...
public class AddKhachHang extends javax.swing.JDialog {
    ...
    public AddKhachHang(java.awt.Frame parent, boolean modal, ToolBarAndTableKhachHang tblKH) {
        super(parent, modal);
        initComponents();
        this.tblKH = tblKH;
    }
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        if (errors == null || errors.isEmpty()) {
            ...
            if (result > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Thêm khách hàng thất bại, lỗi hệ thống!", "Thất bại", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, errors, "Thêm khách hàng thất bại", JOptionPane.INFORMATION_MESSAGE);
        }
